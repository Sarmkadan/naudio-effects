...
namespace NAudioEffects
{
    ...
    /// </summary>
    public static class CompressorSampleProviderJsonExtensionsJsonExtensions
    {
        ...
        public static CompressorSampleProvider? FromJson(string json)
        {
            ...
            // Note: Deserialization of CompressorSampleProvider may fail if it lacks a parameterless constructor.
